...
class ClothesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothe" do
    assert_difference("Clothe.count") do
      post clothes_url, params: { clothe: { category_id: @clothe.category_id, color: @clothe.color, material: @clothe.material, name: @clothe.name, price: @clothe.price, size: @clothe.size, stock: @clothe.stock } }
    end
  ...
  test "should update clothe" do
    patch clothe_url(@clothe), params: { clothe: { category_id: @clothe.category_id, color: @clothe.color, material: @clothe.material, name: @clothe.name, price: @clothe.price, size: @clothe.size, stock: @clothe.stock } }
